                        ...
                        <div className="p-6 text-gray-300">
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <h2 className="text-2xl font-bold text-white">Edit User: {user.name}</h2>
                                </div>
                            </div>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <InputLabel htmlFor="password" value="New Password (leave blank to keep current)" className="text-gray-300" />
                                        <TextInput
                                            id="password"
                                            type="password"
                                            name="password"
                                    ...
                                    <div>
                                        <InputLabel htmlFor="password_confirmation" value="Confirm New Password" className="text-gray-300" />
                                        <TextInput
